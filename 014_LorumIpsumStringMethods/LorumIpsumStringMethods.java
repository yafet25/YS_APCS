public class LorumIpsumStringMethods
{
    ...
    String ipsum= lorum.trim();
    //trimed the lorum
    System.out.println( lorum.length());
    System.out.println( lorum.trim());
    System.out.println( ipsum.length());
    System.out.println( ipsum.toUpperCase());
    System.out.println( ipsum.toLowerCase());
    System.out.println(ipsum.equals("Goat"));
    System.out.println(ipsum.equals(lorum));
    System.out.println(ipsum.equals(ipsum));
    System.out.println( ipsum.indexOf("q"));
    System.out.println( ipsum.indexOf("nullam"));
    System.out.println( ipsum.replace("o","x"));
    System.out.println( ipsum.contains("z"));
    //it prints size and the differnt functions print differnt this that helped me answer this
